...
# # WAIVER INTEGRATION (DISABLED)
# # Uncomment the lines below to re-enable waiver signing and storage
# # try:
...
if st.session_state.get('show_summary', False):
    ...
    if summary:
        ...
        # # Waiver confirmation if applicable (DISABLED)
...
with st.form(key="youth_registration"):
    ...
    for idx, field in enumerate(fields_list):
        ...
        if field.get("type") == "section_header":
            ...
            # # Display waiver PDF button right after the waiver section header (DISABLED)
        ...
        # # Update waiver checkbox label (DISABLED)
...
if submitted:
    ...
    if missing:
        ...
        # # Process waiver if integrated (DISABLED)
        ...
        # # Store waiver metadata in session if waiver was processed (DISABLED)
